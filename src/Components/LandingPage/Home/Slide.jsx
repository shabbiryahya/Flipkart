...
const MultiSlide = ({ data,title,timer}) => {
    ...
    return (
        <Component>
            <Deal>
                ...
                <ViewAllButton variant="contained" color="primary"><NavLink to="/products/electronics" style={{textDecoration:"none",color:'white',fontWeight:"bold"}}>View All</NavLink></ViewAllButton>
            </Deal>
            <Divider />
            <Carousel
                swipeable={false}
            ...
            >
                {
                    data.map(temp => (
                        <Link to={`product/electronics`} style={{textDecoration: 'none'}}>
