...
const ProductItem = (props) => {
  ...
  // const{ratings}=props;
  if (props.property.ratings) {
    console.log(props.property.ratings.replace('Ratings', ''));
  }

  // var str = props.ratings.replace('Ratings', '');
  // console.log(str);

  return (
    // <NavLink to={`/singleproduct/${property.item_id}`}>
    <>
      <Box
        key={i}
        className="my-box"
            ...
            >
              ...
              {property.ratings && (
                ...
                >
                  ...
                  <Text>
                    {property.ratings
                      ? `(${property.ratings.replace('Ratings', '')})`
                      : null}
                  </Text>
              ...
              {property.category_name === 'fashion' ? (
